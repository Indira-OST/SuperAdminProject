...
public class ProductReviewPageTest extends AbstractPage {
...
//		a.clickloginpage();
	...
	@Test(priority = 2)
		public void ProductReviewSearch() throws InterruptedException {
			...
			new ProductReviewPage(driver)
			.ClickCatalog()
			
			.ClickProductReviewTab()
			.verifyProdRevDetails()
			.verifyPagination("Adobe Photoshop CS4", "Obey Propaganda Hat")
			.verifyShowItems()
			.verifyProdRevSearchProd()
